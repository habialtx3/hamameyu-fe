          ...
          <div className="lg:pr-12 flex flex-col">
            ...
            <div className="space-y-4 mb-8 text-base">
              <p>
                ...
                <span className="text-black font-semibold">Nama pelapor:</span>{" "}
                Warga (User ID: {report.user_id})
              </p>

              <p>
                <span className="text-black font-semibold">Nomor Laporan:</span>{" "}
                #{report.id}
              </p>
            ...
            <div>
              <h3 className="text-black mb-4 font-semibold">
                Foto Bukti ({report.images?.length || 0})
              </h3>
              ...
              <div className="relative border-l border-gray-300 ml-5 space-y-10">
                ...
                <div className="relative pl-10">
                  ...
                  <p className="text-[13px] text-gray-500 mt-1.5 leading-relaxed">
                    Sistem telah menerima laporanmu. Keluhan berhasil diarsip ke
                    dalam database dengan ID #{report.id}.
                  </p>
                </div>
                ...
                <div className="relative pl-10">
                  ...
                  <div
                    className={`absolute -left-[1px] -top-10 w-[1px] h-10 ${report.status !== "pending" ? "bg-[#4ca64c]" : "bg-gray-300"}`}
                  ></div>

                  <div
                    className={`absolute -left-[18px] top-0 w-9 h-9 rounded-full flex items-center justify-center ring-8 ring-[#f4f5f6] ${
                  ...
                  <h4
                    className={`font-bold text-[15px] ${report.status !== "pending" ? "text-black" : "text-gray-400"}`}
                  >
                ...
                <div className="relative pl-10">
                  <div
                    className={`absolute -left-[1px] -top-10 w-[1px] h-10 ${report.status === "done" ? "bg-[#4ca64c]" : "bg-gray-300"}`}
                  ></div>
                  ...
                  <h4
                    className={`font-bold text-[15px] ${report.status === "done" ? "text-black" : "text-gray-400"}`}
                  >
